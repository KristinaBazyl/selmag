...
public class ProductControllerTest {
    ...
    @Mock
    FavouriteProductsClient favoriteProductsClient;
    ...
    void loadProduct_ProductDoesNotExists_ReturnsMonoWithNoSuchElementException(){
        ...
        StepVerifier.create(this.productController.loadProduct(1))
                ...
                .expectErrorMatches(exception -> exception instanceof NoSuchElementException e &&
                        e.getMessage().equals("customer.product.error.not_foud"))
                .verify();
    ...
    @Test
    @DisplayName("Исключение NoSuchElementException должно быть траснслировано в страницу errors/404")
    void handleNoSuchElementException_ReturnsErrors404() {
        ...
        //when
        var result = this.productController.handleNoSuchElementException(exception, model, response);
